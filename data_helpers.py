...
def get_max_length():
    global data_dir
    max_frames = 0
    for filename in os.listdir(data_dir + 'videos'):
        label_path = data_dir + 'annotations/' + filename.replace('.mp4', '.npy')
...
output = Conv3D(num_filters, (kernel_frames, kernel_size, kernel_size))(encoder)
